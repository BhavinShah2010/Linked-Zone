<?php
	...
	include_once ('../APIs/PHPExcel/IOFactory.php');
//	print_r ($data);
//	var_dump ($data);
	...
	<div id="container" data-role="none">
    	<div id="header">
            ...
            <div id="c_bar">
                ...
                <div class="p_ow_pic">
                	<img src="all_admin_img/user_<?php echo $pattern_id; ?>/profile_pic.jpg" width="50" height="50" />
                </div>
        ...
        <div id="main">
  <?php      	 	$filename = $_REQUEST['file_name'];
	$user_id  = $_REQUEST['user_id'];
	
	$file_path = "all_admin_img/user_".$user_id."/".$filename;
...
?>             
        	<!--<div id="main_container">
                ...
                <div id="title_box">
                <div id="search_box">
                <input type="text" name="user_seach" id="user_search" class="user_search" placeholder="Search User To Delete" style="min-height:1.5em;"/>
               ...
               <div id="delete_btn_box">
                       ...
                       <table>
                        <tr>
                            ...
                            <td></td>
                            <td><input type="button" value="Delete User" class="delete_btn"/></td>
                        </tr>
                        </table>
               		 </div>
                </div><!-- delete_btn_box--
...
<!-- Akhtra Div for getting Hr-->
            ...
            <div id="delete_box">
            	<div id="delete_btn_box">
                    <input type="button" value="Delete User" class="delete_btn"/>
                </div>
              </div>
