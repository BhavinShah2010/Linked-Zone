...
?>-->
		...
		<div id="mainContainer">
            	...
            	<div id="admin_activity_cont">
                	<div class="new_post">
                    	<div class="user_pic">
                   		...
                   		<div  id="post_type">
						<form name = "homepost" id="upload" action="../scripts_php/admin_addDoc.php" method="POST" enctype="multipart/form-data">
						<textarea name="postVal" rows="4" tabindex="1" cols="50" maxlength = 50 placeholder="Enter About Report (50 Characters)"></textarea>
						<input type="file" id="fileselect" name="fileselect[]" multiple onchange="File_report_Handler (event)" />                        	
                  		  <div id="sel_opt">
                          	<select name="type_of_report" onchange="select_report_type(this)">
                            	<option value="0">Select Type Of Report </option>
                                <option value="1">Attendence Report</option>
                                <option value="2">Result Report </option>
                            </select>
                            <select name="for_which_year" onchange="for_year (this)">
                             ...
                             <div id="post_cancel_btns">
                                ...
                                <input type="button" value="Post" id="post_btn" tabindex="2" name="postBtn" onClick="prc_report_files ()" />
                ...
                <div id="all_post" style="width:80%;margin:0 auto;margin-left:10%;margin-top:-40%;margin-bottom:20%;">
				</div>
        </div><!--mainContainer-->
