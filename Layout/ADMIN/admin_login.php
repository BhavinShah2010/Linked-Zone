...
<div id="login_outer">
   ...
   <form name="frm" method="post">
    ...
    <tr>
    	<td>Username</td>
        <td><input type="text"  id="adminname" name="admin_name" size="27" /></td> 
    </tr>

    <tr>
    	<td>Password</td>
        <td><input type="password" id="adminpass" name="admin_pass" size="27"/></td>
    </tr>

    <tr>
        <td><input type="button"  name="b_login" id="btn" onClick="validate_all()" value="LOGIN" style="margin-left:0px;"/></td>
        <td> <a href="#" style="margin-left:10px;"> Forgot Password?</a> <br />
        	<span id="error"></span>
...
<div id="header_strip"  style="box-shadow:0px -1px 2px black;"></div>
    ...
    <div id="nav_bar" style="float:right;">
    	...
    	<div class="button1"><a href="facebook.com" onMouseOver="chg_img('fb' , 'url(images/facebook1.png)')" onMouseOut="chg_img('fb' , 'url(images/facebook.png)')"> <div class="icon" id="fb" style="background:url(images/facebook.png); float:right;"></div></a></div>
        <div class="button1"><a href="twitter.com"  onmouseover="chg_img('tw' , 'url(images/twitter1.png)')" onMouseOut="chg_img('tw' , 'url(images/twitter.png)')"> <div class="icon" id="tw" style="background:url(images/twitter.png);"></div></a></div>
        <div class="button1"><a href="gmail.com"  onmouseover="chg_img('gp' , 'url(images/googleplus1.png)')" onMouseOut="chg_img('gp' , 'url(images/googleplus.png)')"> <div class="icon" id="gp" style="background:url(images/googleplus.png);"></div></a></div>        
	</div>
  </div>
  </body>
  <?php  } ?>
