...
<script src="scripts/search_friend.js"></script>
        ...
        <div id="main_search_cnt">
        	<div id="search_box">
            	<form name="search_frm" action="">
                	<input type="text" name="search_query" placeholder="Search Your Friend"  onkeyup="search_friends(this.value)" />
...
<!--            	<li>
                    ...
                    <div class="searched_person_cnt">
                        <div class="searched_person_pic"></div>
                        <div class="searched_person_det">
                            <span>Harsh Soni</span>
                        </div>
                    </div>
                    </a>
                    <a href="#"><div class="add_frn_btn">Want To Link?</div></a>
               </li> -->
